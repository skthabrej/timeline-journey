...
const timelineItemsList = [
  ...
  },
  {
    ...
    categoryId: 'PROJECT',
    title: '26 MAY 2022',
    projectTitle: 'FASHION FIESTA',
    description:
      'Fashion Fiesta application is an E-commerce application like Amazon, Flipkart where users can log in and see the list of products with search, filters, sort by, etc.',
    imageUrl: 'https://i.postimg.cc/VkLjntcw/peakpx.jpg',
    duration: '6 hrs',
